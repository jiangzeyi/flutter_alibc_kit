...
class FlutterAlibc {
  ...
  ///
  static void loginTaoBao({LoginCallback loginCallback}) async {
  ...
  /// 「对应官方文档【Client-side flow】方式」 {https://open.taobao.com/doc.htmdocId=118&docType=1}
  /// @param {type}
  /// @return:
  /// Map<String,String>
  static void taoKeLogin(
      ...
      String backUrl,
      CommonCallback taokeCallback}) async {
  ...
  /// 「对应官方文档【Server-side flow】方式」 {https://open.taobao.com/doc.htmdocId=118&docType=1}
  /// @param {type}
  /// @return:
  /// Map<String,String>
